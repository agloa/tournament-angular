# `tournament-angular` — AngularJS app for tournaments

This project is an AngularJS front-end for a tournament registration/administration app.
...
app/                  --> all of the source files for the application
  ...
  person/                --> the person view template and logic
    person.html            --> the partial template
    person.js              --> the controller logic
